    ...
    public partial class AddUserForm : Form
    {
        ...
        private async void Add()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                SystemRecordHelper.Add("Adding new User",
                    $" Added User with ID Number : {users.Id}");
                page.LoadData();
        ...
        private async void Edit()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                // Success
                SystemRecordHelper.Add("Editing User",
                    $" Editing User with Id Number  {users.Id} is Done");
                page.LoadData();
