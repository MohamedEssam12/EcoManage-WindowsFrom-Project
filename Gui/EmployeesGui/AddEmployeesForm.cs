...
using Eco.Core;
using Eco.Data.EF;
using EcoManage.Gui.BookThanksGui;
using EcoManage.Gui.EmployeesRecordGui;
    ...
    public partial class AddEmployeesForm : Form
    {
        ...
        private async void AutoFillData()
        {
            ...
            if (await Task.Run(() => dataHelperForEmployees.IsCanConnect()))
            {
                ...
                dataList.Add("Bonus In progress");
                dataList.Add("Promotion In progress");
        ...
        private void AutoComplete(List<SalaryRate> salaryRateslist)
        {
            ...
            if (currentRate != null)
            {
                if (currentRate.PromotionYear == currentStage)
                {
                    ...
                    comboBoxEmpState.SelectedItem = "Promotion";
                }
                else
                {
                    // علاوة
                    ...
                    comboBoxEmpState.SelectedItem = "Bonus";
                }
        ...
        private async void Add()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                SystemRecordHelper.Add("Added Employee",
                    $"New Employee is added with ID num : {employees.Id}");
                page.LoadData();
        ...
        private async void AddRecored()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                SystemRecordHelper.Add("Employee Record Added",
                    $"New Employee is added with ID number : {employees.Id}");
                page.LoadData();
                ToastHelper.ShowAddToast();
                Id = employees.Id;
                SetRoleOfTabs();
        ...
        private async void Edit()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                SystemRecordHelper.Add("Editing Employee",
                    $" Employee is Edited with ID number :{employees.Id}");
                page.LoadData();
        ...
        private void buttonUpgrade_Click(object sender, EventArgs e)
        {
            ...
            var reuslt = MessageBox.Show("Are You Sure You want to Promote This Employee", "Promote", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
