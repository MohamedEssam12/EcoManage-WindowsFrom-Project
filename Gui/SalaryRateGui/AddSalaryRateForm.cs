    ...
    public partial class AddSalaryRateForm : Form
    {
        ...
        private async void Add()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                SystemRecordHelper.Add("Adding Degree",
                    $"Adding the current position with ID {salaryRate.Id} is finished");
                page.LoadData();
        ...
        private async void Edit()
        {
            ...
            if (result == "1")
            {
                ...
                // Success
                SystemRecordHelper.Add("Editing Degree",
                    $"Editing the current position with ID {salaryRate.Id} is finished");
                page.LoadData();
        ...
        private void AddSalaryRateForm_Load(object sender, EventArgs e)
        {
